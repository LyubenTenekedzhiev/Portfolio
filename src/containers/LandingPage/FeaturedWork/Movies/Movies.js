...
function FooNetflixBar() {
  return (
    <div className={classes.FeaturedWork}>
      ...
      <h3 className={classes.FeaturedWorkStack}>Tech stack: React, JavaScript, CSS, themoviedb's API, HLS, Shaka player</h3>
      <p className={classes.FeaturedWorkDescription}>
        FooNetflixBar started as an interview assignment and even though the functionality is quite limited for now, it has taught me more than I
        expected - the most important of which is: "Once you find yourself surrounded by unknowns and problems, start breaking them into
        smaller chunks. Every tiny part has a simpler solution and gradually helps you with tackling the greater issue."
      </p>
