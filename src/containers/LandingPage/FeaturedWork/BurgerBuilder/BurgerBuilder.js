...
import firstImg from "../../../../assets/burger-mobile-modal.png";
import secondImg from "../../../../assets/burger-mobile-auth.png";
import thirdImg from "../../../../assets/burger-mobile-orders.png";
import introImage from "../../../../assets/burger-intro.png";
import Navigation from "./../../../../components/Navigation/Navigation";
import Footer from "./../../../../components/Footer/Footer";
import ScrollToTopOnMount from "./../../../../functions/ScrollToTopOnMount";

import CarbonCalc from "../../../../assets/cfc.png";
...
function CarbonCalculator() {
  return (
    <div className={classes.FeaturedWork}>
      ...
      <h3 className={classes.FeaturedWorkStack}>Tech stack: React, JavaScript, Redux, CSS, Firebase</h3>
      ...
      <div className={classes.FeaturedWorkProcess}>
        ...
        <p className={classes.FeaturedWorkProcessText}>
          ...
          the presence of React in my tech stack, I devoted 2 hours every night after finishing my daily bootcamp studies to this new magical
          JavaScript library. This is how the Burger Builder came to life and got the React ball rolling for me. <br></br>Kudos to Max Schwarzmüller for making this course and to Dan
          Abramov/Ryan Florence for being a constant motivation.
        </p>
      </div>
